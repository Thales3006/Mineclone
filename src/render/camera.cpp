...
glm::mat4 Camera::getMatrixView() { return glm::lookAt(position, position + direction, up); }
...
void Camera::setSensitivity(float newSensitivity) { sensitivity = newSensitivity; }
